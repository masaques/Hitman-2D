...
/**
 * La idea de este enum es que represente los distintos estados de la maquina de
 * estados, cada uno sabe a que estado irse segun el contexto, o llamar al
 * metodo de la interfaz Moody que le corresponde, para que el NPC se comporte
 * segun su implementacion.
 * 
 * @author traies
 *
 */
public enum NPCState implements State<Moody> {
	...
	/**
	 * El estado alarm toma el control cuando el jugador esta a la vista del
	 * NPC, o cuando todavia puede moverse a la ultima posicion que ocupo. En
	 * caso contrario, el NPC pasa a SUSPICIOUS
	 */
	ALARM() {
		@Override
	...
	/**
	 * El estado SUSPICIOUS toma el control cuando el npc escucha un sonido o
	 * cuando, despues de haber visto al jugador, continua investigando el area.
	 * Pasa a ALARM si ve al jugador o a calm si se acaba el tiempo.
	 * 
	 */
	SUSPICIOUS() {
