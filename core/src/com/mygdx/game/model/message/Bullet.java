...
public class Bullet implements Message<BulletListener> {
	...
	/*
	 * Quizas esto podria ser una variable, diferentes rangos representan
	 * diferentes armas.
	 */
	private static float RANGE = 1500f;
	/*
	 * Serian como los puntos de vida que disminuye del objetivo Idem anterior
	 */
	 ...
	 * 
	 * @param source
	 *            - Personaje que dispara (en caso de que se implemente
	 *            FriendlyFire)
	 * @param position
	 *            - Posición de origen
	 * @param direction
	...
	/**
	 * Metodo privado que verifica en cada uno de los segmentos del hitBox del
	 * listener si el segmento que representa la Bullet lo intersecta
	 * 
	 * @param hitBox
