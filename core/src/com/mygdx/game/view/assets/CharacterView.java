...
/**
 * Implementacion del View de los Character segun el patron MVC. Dibuja en
 * pantalla el sprite del personaje.
 */
public abstract class CharacterView<T extends Character> implements View {
	 ...
	 * 
	 * @param sprite_path
	 *            - Path de la textura a mostrar
	 * @param sprite_width
	 *            - Ancho de la textura
	 * @param spriteLength
	 *            - Largo de cada frame
	 * @param animation_length
	 *            - Cantidad de fotogramas en la animacion
	 */
	public CharacterView(SpriteBatch batch, Animation walkAnimation, Animation hurtAnimation,
	...
	protected void drawFrame() {
		...
		batch.draw(currentFrame, position.x - width / 2, position.y - height / 2, width / 2, height / 2, width, height,
				1f, 1f, rotation);
		batch.end();
	}
