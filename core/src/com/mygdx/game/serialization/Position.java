...
/**
 * Clase que modela a un elemento del archivo XML que representa al nivel
 * 
 * @author masaques
 * @see Level
 *
...
public class Position {
	...
	/**
	 * Metodo que convierte una lista de Position dada a una lista de Vector2
	 * 
	 * @param positions
	 *            : La lista de Position a convertir
